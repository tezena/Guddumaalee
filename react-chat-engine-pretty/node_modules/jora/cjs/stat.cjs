...
const maxHeap = require('./max-heap.cjs');
...
const createStatApi = (source, points) => ({
    ...
    suggestion(pos, options) {
        ...
        const storageType = sort && isFinite(limit) ? maxHeap.MaxHeap : Set;
        ...
        for (const range of ranges) {
            ...
            if (!typeSuggestions.has(type)) {
                ...
                switch (storageType) {
                    case maxHeap.MaxHeap:
                        storage = new maxHeap.MaxHeap(
                            limit,
                            sort,
