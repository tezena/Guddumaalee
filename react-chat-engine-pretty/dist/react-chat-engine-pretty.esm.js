...
var ChatHeader = function ChatHeader(props) {
  ...
  }, props.username), React.createElement("p", null, otherMember.is_online ? 'Online' : 'Offline'))), React.createElement("div", {
...
var ChatForm = function ChatForm(props) {
  ...
  }, React.createElement(PlusOutlined, null)), React.createElement("style", null, ".ce-create-chat-button:hover { background-color: #7b3bc8; }"));
};
...
var ChatListHeader = function ChatListHeader(props) {
  ...
  }, "All Messages"), React.createElement("button", {
