...
const AdminSidebar = () => {
  ...
  return (
    <>
      ...
      <aside
        id="logo-sidebar"
        className="fixed top-0 left-0 z-40 w-56 p-2 h-[94vh] shadow-lg mt-4 ml-4 rounded-2xl transition-transform -translate-x-full bg-white border-r border-gray-200 lg:translate-x-0"
        aria-label="Sidebar"
      >
